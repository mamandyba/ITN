    ...
    <footer class="footer-area">
        <div class="footer-shape">
            <img src="<?= base_url()?>assets/frontend/img/shape/03.png" alt="">
        </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="footer-widget-box about-us">
                            <a href="#" class="footer-logo">
                                <img src="<?= base_url()?>assets/frontend/img/logo/ub.png" style="height: 80px; width: 80px;" alt="">
                            </a>
                            <p class="mb-3">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#325b5c545d72574a535f425e571c515d5f"><i
                                            class="far fa-envelope"></i><span class="__cf_email__" data-cfemail="e0898e868fa08598818d908c85ce838f8d">[email&#160;protected]</span></a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 align-self-center">
                            <p class="copyright-text">
                                &copy; Copyright <span id="date"></span> <a href="#"> UB-ITN </a> All Rights Reserved.
                            </p>
                        </div>
                        <div class="col-md-6 align-self-center">

...
class Applications extends MY_Controller {
	...
	{   
		 ...
		 $sql = "SELECT a.*, u.first_name 
                FROM applications a
                JOIN users u ON u.Id = a.Id";

        $data['applications'] = $this->Model->readQuery($sql);
	...
	function ApplicationsDetail($applicationsDetail){
	  $idapplications=explode('_', $applicationsDetail);
	  $data['applications']=$this->Model->readOne('applications',['id'=>$iddepartemts[0]]);
	  $this->load->view('ApplicationsDetail_View.php',$data);
	}
